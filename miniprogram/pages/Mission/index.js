Page({
  data: {
    ...
    slideButtons: [
      { extClass: 'markBtn', text: '标记', src: "success" },
      { extClass: 'starBtn', text: '星标', src: "star-o" },
      { extClass: 'removeBtn', text: '删除', src: 'delete-o' }
    ],
  ...
  async getSwiperList() {
    const that = this;
    wx.cloud.callFunction({ name: 'getSwiperData', data: { type: "Mission" } })
      .then(res => {
        that.setData({
